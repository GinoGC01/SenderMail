export const htmlContent = (nombreEstudio) => {
  ...
  const messageImprove = `<html>
    ...
    <body>
      <div class="container">
      <header class="header">
        <h1>Transforme su pagina web con una presencia sólida: REFACCIONAR PAGINA</h1>
      </header>
        ...
        <p>Estoy convencido de que una presencia web sólida puede transformar la forma en que su estudio se conecta con clientes potenciales y actuales. Al actualizar y optimizar su sitio web, su estudio no solo aumentará su visibilidad en línea, sino que también podrá ofrecer una experiencia más profesional y accesible para sus clientes.</p>
