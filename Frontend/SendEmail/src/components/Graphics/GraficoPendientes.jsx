...
export default function GraficoPendientes({ label }) {
  const { estudios } = useGraficosData();
  //si estudios.pendiente === null || undefined → number === 0
  const number = estudios.pendientes ?? 0;
